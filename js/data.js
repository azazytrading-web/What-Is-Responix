...
const demoData = {
    ...
    // Recent Activity
    activities: [
        { type: 'booking', icon: 'green', name: 'Ahmed Al-Khaldi', time: '2m ago', timeAr: 'منذ ٢ د', detail: 'AC Cleaning, 3 units' },
        { type: 'lead', icon: 'blue', name: 'Sarah Fahd', time: '5m ago', timeAr: 'منذ ٥ د', detail: 'Qualified by AI' },
        { type: 'payment', icon: 'green', name: 'Mohammed Al-Otaibi', time: '12m ago', timeAr: 'منذ ١٢ د', amount: '450' },
        { type: 'escalated', icon: 'orange', name: 'Layla Nasser', time: '18m ago', timeAr: 'منذ ١٨ د', agent: 'Fahad Khan' },
        { type: 'ai', icon: 'purple', name: 'Khalid Al-Rashid', time: '25m ago', timeAr: 'منذ ٢٥ د', detail: 'Auto-handled' },
        { type: 'followup', icon: 'blue', name: 'Noura Al-Saud', time: '32m ago', timeAr: 'منذ ٣٢ د', detail: 'Pending quote' }
    ],
